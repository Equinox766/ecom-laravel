...
<head>
  ...
  <title>@yield('pagetitle') - EcomShop Dashboard</title>
  <!-- General CSS Files -->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="{{ route('admin.allcategory')}}">All Categorys</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="box"></i><span>Sub Category</span></a>
              <ul class="dropdown-menu">
            ...
            <li class="dropdown">
              <a href="{{ route('admin.addproduct')}}"><i data-feather="shopping-cart"></i><span>Add Product</span></a>
              <a href="{{ route('admin.allproduct')}}"><i data-feather="shopping-cart"></i><span>All Products</span></a>
            </li>
